...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sidebarHTML = {
        ...
        'spectrogram': `
            <div id="sidebar-canvas">
                <div id="sidebar-content">
                    <div class="analysis-mode-controls" style="display: flex !important; flex-direction: row !important; align-items: center; gap: 20px;">
                        <div class="form-check form-switch" title="Toggle the temporal fade-out effect. When off, the history will not fade.">
                            <input class="form-check-input" type="checkbox" role="switch" id="spectro-fade-toggle">
                            <label class="form-check-label" for="spectro-fade-toggle">Fade</label>
                        </div>
                        <div class="form-check form-switch" title="Toggle the visual brightness gate. When off, low-level signals and noise floor will be visible.">
                            <input class="form-check-input" type="checkbox" role="switch" id="spectro-bright-toggle" checked>
                            <label class="form-check-label" for="spectro-bright-toggle">Bright</label>
                        </div>
                    </div>
